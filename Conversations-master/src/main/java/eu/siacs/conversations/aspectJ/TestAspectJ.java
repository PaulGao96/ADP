package eu.siacs.conversations.aspectJ;
...
/**
 * Created by cooper on 2017/5/21.
 */
@Aspect
public class TestAspectJ {
    private static final String TAG = "tagliubaiyu";
    @Pointcut("execution(* eu.siacs.conversations.ui.ChangePasswordActivity.onBackendConnected(..))")
    public void test(){}
    //@After("test()")
